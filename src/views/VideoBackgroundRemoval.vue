<template>
  ...
  <v-card style="margin-top: 20px">
    <v-card-text>
      <v-text-field v-model="target_url" label="Target Video" prepend-inner-icon="mdi-web">
      </v-text-field>
...
const target_url = useStorage("VideoBackgroundRemoval-Target", "");

const req_id = ref(0);
const show_result = ref(false);

function submit() {
  const url = "https://deepnarrationapi.matissetec.dev/startVideoBackgroundRemoval"
